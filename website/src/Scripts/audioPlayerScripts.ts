export const initAudio = () => {
  ...
  if (element) {
    ...
    innerHTML += `<audio controls id="O_Audio"><source src="${window.location.href}/assets/audio/232927__bmusic92__mac-start-up.wav" type="audio/wav" /></audio>`;
    ...
    innerHTML += `<audio controls id="V_Audio"><source src="${window.location.href}/assets/audio/345688__inspectorj__comedic-whistle-a.wav" type="audio/wav" /></audio>`;
    ...
    innerHTML += `<audio controls id="SPACE_Audio"><source src="${window.location.href}/assets/audio/386857__bustercherry__squeaky-ringer.wav" type="audio/wav" /></audio>`;
    ...
    innerHTML += `<audio controls id="COMMA_Audio"><source src="${window.location.href}/assets/audio/446000__breviceps__fart-3.wav" type="audio/wav" /></audio>`;
